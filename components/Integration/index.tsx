      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `TECHNOLOGIES`,
              subtitle: `Empowering Innovation with Cutting-Edge Technologies`,
              description: `At TruGenAI, we leverage the latest and most powerful technologies to drive innovation and success. Our technology stack includes industry-leading solutions that enhance performance, streamline processes, and deliver exceptional results.`,
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/tech/Tensorflow_logo.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/tech/dialogflow.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
