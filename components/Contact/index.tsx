        ...
        <div className="relative mx-auto max-w-c-1390 px-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
            ...
            >
              ...
              <form
                action="https://formsubmit.co/gaikwadsanketn@gmail.com"
                method="POST"
              >
                {/* Optional hidden inputs */}
                <input type="hidden" name="_subject" value="New Inquiry Message" />
                <input type="hidden" name="_autoresponse" value="Thanks! We'll get back to you shortly." />
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>Shivaji Nagar, Modern Colony, Pune 411005</p>
              </div>
