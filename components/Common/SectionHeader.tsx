  ...
  return (
    <>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="animate_top mx-auto text-center mb-4"
      >
        <div className="mb-4 inline-block rounded-full bg-titlebg2 px-4.5 py-1.5 dark:border dark:border-strokedark dark:bg-blacksection">
